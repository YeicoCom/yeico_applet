defmodule Applet.CompileTest do
  ...
  test "compile error undefined function" do
    ...
    Tester.assert_contains(route, :error, "#{route}:1 compile error undefined function fun/0")
  end
  ...
  test "compile error undefined variable" do
    ...
    Tester.assert_contains(
      route,
      :error,
      "#{route}:1 compile error undefined variable \"fun\""
    )
  end
  ...
  test "compile warning unused variable" do
    ...
    Tester.assert_contains(route, :warn, "#{route}:1 compile warning variable \"a\" is unused")
  end
end
